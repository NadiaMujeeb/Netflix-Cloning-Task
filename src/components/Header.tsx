  ...
  return (
    <div className="relative overflow-hidden w-full h-screen">
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-4">
        <div className="mb-7">
          <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-extrabold mb-3">Unlimited movies, TV</h1>
          <h1 className="text-white text-3xl md:text-4xl lg:text-5xl font-extrabold mb-5">shows and more</h1>
          <p className="text-white text-lg md:text-xl lg:text-2xl font-semibold">Starts at ₹149. Cancel anytime.</p>
        </div>
