...
// <p className='text-center mb-4'> <a href="/ForgotPass" className='text-white text-lg hover-yellow'>Forgot Password?</a></p>
...
const SignIn = () => {
  ...
  return (
    <div className="relative overflow-hidden w-full h-screen flex flex-col justify-center items-center">
     ...
     <p className='text-center mb-4'> <a href="/ForgotPass" className='text-white text-lg hover-yellow'>Forgot Password?</a></p>
 <p className='text-white text-sm text-center mb-4'>   New to Netflix? Please <a href="/signup" className='text-yellow-500 underline'>Sign up now.</a></p>
<p className='text-white text-xs text-center'>This page is protected by Google reCAPTCHA to ensure you're not a bot.</p>
      </div>
    </div>
  );
